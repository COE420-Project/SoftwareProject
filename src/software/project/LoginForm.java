...
public class LoginForm extends javax.swing.JFrame {
    ...
    try {
        ...
        for (int i = 0; i < hashedBytes.length && sb.length() < maxCharacters; i++) {
            sb.append(String.format("%02x", hashedBytes[i]));
        }
        return sb.substring(0, Math.min(sb.length(), maxCharacters));
 ...
 //mohammed
    ...
    if (isValid) {
        ...
        if (userType.equals("ADMIN") || userType.equals("CLIENT")) {
            loggedInClientEmail = email;
            if (userType.equals("ADMIN")) {
                    new Admin_Interface(loggedInClientEmail).setVisible(true);
                } else if (userType.equals("CLIENT")) {
                    new User_Interface(loggedInClientEmail).setVisible(true);
                }
    ...
    private void register_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_register_btnActionPerformed
        ...
        String username = username_field1.getText();
        String password = encryptPassword(pass_field.getText());
